...
(async () => {
  ...
  // Answerable right now even though the reminder is 2h out — navigating to
  // the story drops straight into this card, no button needed.
  ...
  await page.waitForSelector('.rs-story', { timeout: 4000 });
